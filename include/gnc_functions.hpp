...
{
	std::vector<double> b = {current_pose_g.pose.pose.position.x, current_pose_g.pose.pose.position.y, current_pose_g.pose.pose.position.z};
	return b;
}
...
int init_publisher_subscriber(ros::NodeHandle controlnode)
{
	...
	bat_sub = controlnode.subscribe<sensor_msgs::BatteryState>((ros_namespace + "sensor_msgs/BatteryState").c_str(), 10, state_b);
	vel_sub = controlnode.subscribe<geometry_msgs::TwistStamped>((ros_namespace + "geometry_msgs/TwistStamped").c_str(), 10, velocity_s);
